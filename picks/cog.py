...
class Picks(commands.GroupCog, name="picks"):
    """
    A picks system for claiming Balls!
    """
    ...
    @app_commands.command(name="daily", description="Pick your daily ball!")
    async def daily(self, interaction: discord.Interaction[BallsDexBot]):
        ...
        pick_embed = Embed(title="Pick a ball", color=Color.blue())
        ...
        logger.info(
            ...
            f"Daily pick used | Ball ID: `#{ball.pk:0X}`"
        )

    @app_commands.command(name="weekly", description="Pick your weekly Ball!")
    ...
    async def weekly(self, interaction: discord.Interaction[BallsDexBot]):
        ...
        # Create pick selection embed
        pick_embed = Embed(title="Pick a Ball", color=Color.purple())
    ...
    async def wallet(self, interaction: discord.Interaction[BallsDexBot]):
        ...
        embed.set_footer(text="Dex Wallet")
    ...
    async def pick(self, interaction: discord.Interaction[BallsDexBot]):
        ...
        # Create pick selection embed
        pick_embed = Embed(title="Pick a Ball", color=Color.orange())
        ...
        walkout_embed.set_footer(text="Dex Picks")
        await msg.edit(embed=walkout_embed, view=None)
